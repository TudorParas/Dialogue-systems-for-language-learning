...
def get_iterator(src_dataset,
                 ...
                 skip_count=None):
    """
    Create iterator for the training or evaluation graph.We do not use a dialogue_max_len because that would give
    false targets
    :param src_dataset: The dataset consisting of utterances separated by eou
    :param tgt_dataset: The dataset consisting of the response for the source
